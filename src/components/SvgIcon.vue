...
const ICONS: Record<string, IconSpec> = {
  ...
  telescope: {
    paths: [
      { d: 'M12.1 11.6L8.2 21.3' },
      { d: 'M12.1 11.6L15.6 21.3' },
      { d: 'M5.52 11.34L17.95 2.79L20.11 5.91L7.68 14.46Z', filled: true },
      { d: 'M14.64 2.99L15.80 2.19L18.64 6.29L17.48 7.09Z', filled: true },
      { d: 'M5.64 11.86L7.24 14.16L6.08 14.96L4.48 12.66Z', filled: true },
    ],
  },
