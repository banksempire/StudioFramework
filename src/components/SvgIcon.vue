...
const ICONS: Record<string, IconSpec> = {
  ...
  '»': {
    paths: [{ d: 'm6 17 5-5-5-5' }, { d: 'm13 17 5-5-5-5' }],
  },
  '›': {
  ...
  binoculars: {
    paths: [
      {
        d: 'M10 10h4m5-3V4a1 1 0 0 0-1-1h-2a1 1 0 0 0-1 1v3m5 14a2 2 0 0 0 2-2v-3.851c0-1.39-2-2.962-2-4.829V8a1 1 0 0 0-1-1h-4a1 1 0 0 0-1 1v11a2 2 0 0 0 2 2zm2-5H2m2 5a2 2 0 0 1-2-2v-3.851c0-1.39 2-2.962 2-4.829V8a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1v11a2 2 0 0 1-2 2zM9 7V4a1 1 0 0 0-1-1H6a1 1 0 0 0-1 1v3',
      },
    ],
  },
  ...
  '🤖': {
    paths: [
      ...
      { d: 'M19 15h2.4' },
      {
        d: 'M10.4 9.5h3.2a0.9 0.9 0 0 1 0.9 0.9v3.2a0.9 0.9 0 0 1-0.9 0.9h-3.2a0.9 0.9 0 0 1-0.9-0.9v-3.2a0.9 0.9 0 0 1 0.9-0.9Z',
        filled: true,
      },
    ],
  },
