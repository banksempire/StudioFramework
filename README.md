...
├── check-utils.cjs          # Sub-section utility buttons always visible (13 assertions)
...
| `npm run check:utils` | Sub-section utility buttons always visible (hover/active reveal removed) | 13 |
